fn main() {
    let src_dir_block = std::path::Path::new("tree-sitter-markdown/tree-sitter-markdown/src");
    let src_dir_inline =
        std::path::Path::new("tree-sitter-markdown/tree-sitter-markdown-inline/src");
